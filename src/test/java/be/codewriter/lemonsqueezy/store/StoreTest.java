...
class StoreTest extends BaseTest {
    ...
    void shouldParseStore() throws IOException {
        ...
        assertAll(
                ...
                () -> assertEquals("my-store.lemonsqueezy.com", attr.getDomain(), "Store attributes color should be equal"),
                () -> assertEquals("https://demo-store.lemonsqueezy.com", attr.getUrl(), "Store attributes color should be equal"),
                () -> assertEquals("https://app.lemonsqueezy.com/storage/avatars/stores/1/czTkMkDm4Vfb8PZehb5c29XFCm9JZyJx0AjEZP7s.png", attr.getAvatarUrl(), "Store attributes color should be equal"),
                () -> assertEquals("fresh", attr.getPlan(), "Store attributes color should be equal"),
                () -> assertEquals("US", attr.getCountry(), "Store attributes color should be equal"),
                () -> assertEquals("United States", attr.getCountryNicename(), "Store attributes color should be equal"),
                () -> assertEquals("USD", attr.getCurrency(), "Store attributes color should be equal"),
                () -> assertEquals(1, attr.getTotalSales(), "Store attributes color should be equal"),
                () -> assertEquals(999, attr.getTotalRevenue(), "Store attributes color should be equal"),
                () -> assertEquals(0, attr.getThirtyDaySales(), "Store attributes color should be equal"),
                () -> assertEquals(0, attr.getThirtyDayRevenue(), "Store attributes color should be equal"),
    ...
    void shouldParseStoreResponse() throws IOException {
        ...
        assertAll(
                ...
                () -> assertEquals("my-store", attr.getSlug(), "Store attributes email should be equal"),
                () -> assertEquals("my-store.lemonsqueezy.com", attr.getDomain(), "Store attributes color should be equal"),
                () -> assertEquals("https://my-store.lemonsqueezy.com", attr.getUrl(), "Store attributes color should be equal"),
                () -> assertEquals("https://app.lemonsqueezy.com/storage/avatars/stores/1/czTkMkDm4Vfb8PZehb5c29XFCm9JZyJx0AjEZP7s.png", attr.getAvatarUrl(), "Store attributes color should be equal"),
                () -> assertEquals("fresh", attr.getPlan(), "Store attributes color should be equal"),
                () -> assertEquals("US", attr.getCountry(), "Store attributes color should be equal"),
                () -> assertEquals("United States", attr.getCountryNicename(), "Store attributes color should be equal"),
